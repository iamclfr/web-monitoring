        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <form class="space-y-6" method="POST" action="/wordpress/{{ $domaineSlug }}" enctype="multipart/form-data">
                    ...
                    <div>
                        <x-label for="etat_sante" :value="__('État de Santé')" />
                    ...
                    <div>
                        ...
                        <textarea name="commentaire" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" id="commentaire" cols="100%" rows="5"></textarea>
                    </div>
